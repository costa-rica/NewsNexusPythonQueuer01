...
**Requirements:**
- DO NOT use tqdm or progress bars that generate multi-line terminal output
- Use logger-based progress updates for long-running operations (>5 seconds expected duration)
- Operations under 5 seconds only need success/failure completion logs

**Interval pattern:**
- Log at 1% completion (first milestone)
- Then log at 10% intervals (10%, 20%, 30%... 90%)
- Always log 100% completion

**Format:** `"Processing items: XX% (current_count/total_count)"`
